...
def visualization_page():
    ...
    st.markdown("""
        <iframe width="600" height="450" src="https://datastudio.google.com/embed/reporting/88cbb69d-8792-440d-b8d4-e232eca1c746/page/6Z7gC" frameborder="0" style="border:0" allowfullscreen></iframe>
